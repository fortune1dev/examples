...
contract PRIGOJIN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "PRIGOJIN INU";
    string private _symbol = "PRIGOJIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x1120eDAcb2e6800b5e02D38946dC3125B757d084); // Marketing Address
    address payable public teamWalletAddress =
        payable(0xF751c13045946C0daf1aD9f99aB339BF52Ef5946); // Team Address
